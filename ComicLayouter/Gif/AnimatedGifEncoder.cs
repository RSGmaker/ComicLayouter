...
namespace Gif.Components
{
	public class AnimatedGifEncoder
	{
		 ...
		 */
		public bool AddFrame(Image im,int del = 0) 
		{
            if (del <= 0)
            {
                del = delay;
			...
			try 
			{
				...
				WriteGraphicCtrlExt(del); // write graphic control extension
...
//			}
		 ...
		 */
		protected void WriteGraphicCtrlExt(int del=0) 
		{
            if (del <= 0)
            {
                del = delay;
			...
			WriteShort(del); // delay x 1/100 sec
